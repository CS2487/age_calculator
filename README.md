...
✅ الملاحظات:  
- يجب **إغلاق كل كتلة كود** بـ ```` ``` ```` حتى لا يحصل خطأ في Markdown.  
- استخدمت فصل واضح بين خطوات الإعداد وعبارة **Made with ❤️** لتبدو احترافية.  

إذا تحب، أقدر أدمج هذا مع بقية README.md ليكون **كامل وجاهز على GitHub**. تريد أن أفعل ذلك؟
